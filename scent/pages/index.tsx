...
const home = () => {
  return (
    <div>
      ...
      <div className="mb-32 mt-32 flex h-[360px] w-full flex-col items-center justify-center gap-6 border-solid border-smBorderColor bg-smColor text-center shadow-md"></div>
      <Footer />
    </div>
  );
};
