...
const home = () => {
  return (
    <div>
      ...
      <div className="mb-32 mt-32 grid h-[360px] w-full grid-cols-4 items-center justify-center justify-items-center gap-2 border-y-2 border-solid border-smBorderColor p-4 shadow-md">
        <Card />
        <p>
